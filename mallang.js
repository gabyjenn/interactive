...
//new audio script//
console.clear();
var audioA = new Audio('sounds/ti.wav');
audioA.load();
...
console.clear();
var audioB = new Audio('sounds/la.wav');
audioB.load();
...
console.clear();
var audioC = new Audio('sounds/sol.wav');
audioC.load();
...
console.clear();
var audioD = new Audio('sounds/fa.wav');
audioD.load();
...
console.clear();
var audioE = new Audio('sounds/mi.wav');
audioE.load();
...
console.clear();
var audioF = new Audio('sounds/re.wav');
audioF.load();
...
console.clear();
var audioG = new Audio('sounds/do.wav');
audioG.load();
